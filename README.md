...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/gradientai-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gradientai-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install gradientai
```
...
It is possible to list all of the versions of `gradientai` available on your platform:
...
```
pixi search gradientai --channel conda-forge
```
